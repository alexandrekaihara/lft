...
class ONOS(Controller):
    def instantiate(self, dockerImage="onosproject/onos", dockerCommand="docker run -dit -p 8181:8181 -p 8101:8101 -p 5005:5005 -p 830:830 --privileged --name=c1 onosproject/onos") -> None:
